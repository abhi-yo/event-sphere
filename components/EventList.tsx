...
export default function EventList({ onEventSelect }: EventListProps) {
  ...
  return (
    ...
    <h2 className="text-3xl font-extrabold mb-4 pb-1 relative inline-block overflow-hidden group">
          ...
          <span className="absolute bottom-0 left-0 w-full h-0.5 bg-black transform scale-x-0 transition-transform duration-300 ease-in-out group-hover:scale-x-100"></span>
        </h2>
