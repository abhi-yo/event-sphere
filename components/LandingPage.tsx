...
const FeatureCard = ({ icon, title, description }) => {
  return (
    <div
      className={`${inter.className} bg-white/70 rounded-3xl p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-white/90 cursor-pointer relative overflow-hidden`}
    >
...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(globeRef.current, {
      ...
      markers: [
        { location: [37.7749, -122.4194], size: isMobile ? 0.03 : 0.04 },
        { location: [40.7128, -74.006], size: isMobile ? 0.025 : 0.035 },
        { location: [51.5074, -0.1278], size: isMobile ? 0.04 : 0.05 },
        { location: [35.6762, 139.6503], size: isMobile ? 0.02 : 0.03 },
        { location: [1.3521, 103.8198], size: isMobile ? 0.035 : 0.045 },
        { location: [-33.8688, 151.2093], size: isMobile ? 0.03 : 0.04 },
        { location: [55.7558, 37.6176], size: isMobile ? 0.025 : 0.035 },
        { location: [28.6139, 77.209], size: isMobile ? 0.045 : 0.055 },
      ] as Marker[],
      ...
      <main className="flex-grow relative z-[1]">
        ...
        <div className="container mx-auto px-4 pt-4 sm:pt-8 md:pt-16 pb-16 md:pb-48">
          <div className="flex flex-col items-center text-center mb-16 md:mb-48">
            ...
            <p
              className="text-sm md:text-lg text-gray-600 max-w-3xl mx-auto mb-6 md:mb-16 leading-relaxed mt-8 md:mt-16 relative z-10 px-4"
              style={{
          ...
          >
            <div className="text-center mb-8 md:mb-24">
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-3 md:mb-4 tracking-tight font-heading">
                Everything You Need
              </h2>
